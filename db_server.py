...
app.add_url_rule('/scores/<user_name>', view_func=Scorecards.all_scorecards, methods = ["GET", "PUT", "DELETE"])
...
app.add_url_rule('/scorecards/game/<scorecard_id>', view_func=Scorecards.info_of_a_game)
