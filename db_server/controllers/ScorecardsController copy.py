...
def update_delete_return_one_scorecard(scorecard_name):
    ...
    if request.method == "GET":
        ...
        data = request.json
        entireScorecard = scorecard.get_scorecard(scorecard_name)
        try: 
            scorecard = entireScorecard["message"]
            if entireScorecard["result"] == "success":
                ...
                print(scorecards.get_scorecard(scorecard_name))
        except:
            return {}
